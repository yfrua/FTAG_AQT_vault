...
-  The composition in quarks and gluons of the selected sample will be studied, as well the composition in g->bb, g->cc which are counted as b- and c-jets, respectively, and which might have an impact on the calibration according to previous studies.
