...
| trigger name                                                                                                                                                                                 | PS Corr Ready Lumi ($\text{nb}^{-1}$) | Total Lumi in GRL ($\text{nb}^{-1}$)                          | ratio |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------- | ----- |
| [HLT_j20_L1jJ20](https://atlas-tagservices.cern.ch/tagservices/RunBrowser/runBrowserReport/runBrowserReport.php?cn=HLT_j20_L1jJ20 "link to COMA Chain/Item Report for HLT_j20_L1jJ20")       | 1,943                                 | [0](https://atlas-lumicalc.cern.ch/results/61eff/result.html) | \     |
