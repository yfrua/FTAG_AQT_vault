...
- There are $6\times 3=18$ data points (100-90%, 90-85%, 85-77%, 77-70%, 70-65%, 65-0% for WPs and no SV, 0-3 GeV, 3-6 GeV for SV mass) with 2 constraint of $\sum_i \epsilon_{i, MC}^f \times SF_i^f = 1, f=l, b$ (data efficiency adds up to unity) and one one $\sum_f F^f=1$, and $1+3+6*2=16$ parameters to fit. And everything above goes down to a DoF of $18-16+3=5$.
...
- CDI file for tagger metadata (cut value, fraction of b/c/tau): `/cvmfs/atlas.cern.ch/repo/sw/database/GroupData/dev/xAODBTaggingEfficiency/13p6TeV/MC23_2026-08-04_GN3EPCLV01_GN3PflowMuonsV00_GN2v01_v1_noSF.root`.
